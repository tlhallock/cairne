		...
		children={
			...
			spec.EntityType.REGION.get_field_name(): spec.EntityDictionarySpecification(
					entity_specification=spec.EntitySpecification(
						...
						children={
							"name": spec.ValueSpecification.create_string_value(required=True),
							"description": spec.ValueSpecification.create_string_value(required=True),
							"image_prompt": spec.ValueSpecification.create_string_value(required=True),
						}
					)
			),
				...
				entity_specification=spec.EntitySpecification(
					...
					children={
						...
						"archetype": spec.ValueSpecification(
							...
							validators=[spec.OneOfLiteralValidator(
						...
						"description": spec.ValueSpecification.create_string_value(required=True),
						"appearance": spec.ValueSpecification.create_string_value(required=True),
						"history": spec.ValueSpecification.create_string_value(required=True),
						"origin": spec.ValueSpecification.create_string_value(required=True),
						"image_prompt": spec.ValueSpecification.create_string_value(required=True),  # should update with the appearance...
