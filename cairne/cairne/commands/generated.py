...
class CreateEntity(Command):
    ...
    def execute(self) -> generated_schema.CreateEntityResponse:
        ...
        child_path = insert_path.append(generated_model.GeneratablePathElement(entity_id=entity.entity_id))
        self.datastore.save()
...
class GetEntity(Command):
    ...
    def execute(self) -> generated_schema.GetEntityResponse:
        ...
        exported = export.export_generated_entity(path=located_entity.path, generated_entity=located_entity.entity)
