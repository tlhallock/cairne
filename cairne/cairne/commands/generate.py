...
def create_character_generation(request: generate_schema.GenerateRequest) -> generation_model.Generation:
...
def create_characters_generation(request: generate_schema.GenerateRequest) -> generation_model.Generation:
...
def create_generation(request: generate_schema.GenerateRequest) -> generation_model.Generation:
